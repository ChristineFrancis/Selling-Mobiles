    ...
    return Scaffold(
      appBar: AppBar(leading: MaterialButton(onPressed: (){ Navigator.of(context).pop();},
        child: const Icon(Icons.arrow_back_outlined , color:Colors.white ,),),centerTitle: true, backgroundColor: Color(0xffA4A9BC),
          title: Text("VIVO" , style: TextStyle(color: Colors.white ,fontSize: 35, fontWeight: FontWeight.w500, ),)),
      body: Padding(
        ...
        child: ListView(children: [
          Row(children: [Padding(
            ...
            Text("280" ,style: TextStyle(fontWeight: FontWeight.w600 , fontSize: 35) )
          ],),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(" Name:" , style:TextStyle(color:Color(0xffA4A9BC),fontSize: 35, ) ),
          ) ,
          Text("vivo" ,style: TextStyle(fontWeight: FontWeight.w600 , fontSize: 30) ),
          ...
          IconButton(iconSize: 80 , onPressed:(){
            ...
            if(vivonum!=0)
              Get.put(CartController()).addToCart("vivo", vivonum, 280.0);
